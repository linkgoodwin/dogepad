...
export const CONTRACT_ADDRESSES: Record<number, ContractAddresses> = {
  ...
  [ARC_TESTNET]: {
    launchDAO: resolveAddr('VITE_ARC_TESTNET_LAUNCH_DAO_ADDRESS', 'VITE_LAUNCH_DAO_ADDRESS', '0xEba0474Ca1231eB8a4b616127a8C2cE0bFA32545'),
    ...
    perpetualPool: resolveAddr('VITE_ARC_TESTNET_PERPETUAL_POOL_ADDRESS', 'VITE_PERPETUAL_POOL_ADDRESS', '0x44Cc05C5ff8CcA261004b041facFFcA0a31304C4'),
