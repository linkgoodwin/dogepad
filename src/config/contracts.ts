...
export const CONTRACT_ADDRESSES: Record<number, ContractAddresses> = {
  ...
  [ARC_TESTNET]: {
    launchDAO: resolveAddr('VITE_ARC_TESTNET_LAUNCH_DAO_ADDRESS', 'VITE_LAUNCH_DAO_ADDRESS', '0xbf0d1270832668cBDa14Cb0D174009A02394873E'),
    bondingCurve: resolveAddr('VITE_ARC_TESTNET_BONDING_CURVE_ADDRESS', 'VITE_BONDING_CURVE_ADDRESS', '0xaAF2e0Cd18443a67d051d3BaDbd9c3c72B2BA75f'),
    dexLister: resolveAddr('VITE_ARC_TESTNET_DEX_LISTER_ADDRESS', 'VITE_DEX_LISTER_ADDRESS', '0xf9665F1bAE2aD61Ae00164D2C6eE9d8Bd1BA300B'),
    longPool: resolveAddr('VITE_ARC_TESTNET_LONG_POOL_ADDRESS', 'VITE_LONG_POOL_ADDRESS', '0xBeA5B6F12FDFe807C98483350CeE985059718604'),
    shortPool: resolveAddr('VITE_ARC_TESTNET_SHORT_POOL_ADDRESS', 'VITE_SHORT_POOL_ADDRESS', '0x358B5D04c34Cf3fe548D897046CaEF59339851fd'),
    buyAndBurn: resolveAddr('VITE_ARC_TESTNET_BUY_AND_BURN_ADDRESS', 'VITE_BUY_AND_BURN_ADDRESS', '0x71cCd8927fa9Fff324B9cAd42cF93EC62F0a970d'),
    priceOracle: resolveAddr('VITE_ARC_TESTNET_PRICE_ORACLE_ADDRESS', 'VITE_PRICE_ORACLE_ADDRESS', '0xc99F2D6a9c6875F1c19E8ea20385A7065A6815f0'),
    feeDistributor: resolveAddr('VITE_ARC_TESTNET_FEE_DISTRIBUTOR_ADDRESS', 'VITE_FEE_DISTRIBUTOR_ADDRESS', '0x4f70682cd1bd6402e783aA4ee9Eb7C7Eb76130d6'),
    creatorRewardManager: resolveAddr('VITE_ARC_TESTNET_CREATOR_REWARD_MANAGER_ADDRESS', 'VITE_CREATOR_REWARD_MANAGER_ADDRESS', '0x5705A8613923F928d98CC8a93a7A4E3fe0F1091C'),
    factory: resolveAddr('VITE_ARC_TESTNET_FACTORY_ADDRESS', 'VITE_FACTORY_ADDRESS', '0xBF380A6E5Ba33960b45e1Ae8a9a8A14472355072'),
    simpleFactory: resolveAddr('VITE_ARC_TESTNET_SIMPLE_FACTORY_ADDRESS', 'VITE_SIMPLE_FACTORY_ADDRESS', '0x2E70c87797Cddb34F0f71E10da5121C8A78Fb1b7'),
    simpleRouter: resolveAddr('VITE_ARC_TESTNET_SIMPLE_ROUTER_ADDRESS', 'VITE_SIMPLE_ROUTER_ADDRESS', '0x3AbC8B82e240a728235745d24823B4E945f9B0E2'),
  },
}
