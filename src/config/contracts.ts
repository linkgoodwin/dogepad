...
export const CONTRACT_ADDRESSES: Record<number, ContractAddresses> = {
  ...
  [ARC_TESTNET]: {
    launchDAO: resolveAddr('VITE_ARC_TESTNET_LAUNCH_DAO_ADDRESS', 'VITE_LAUNCH_DAO_ADDRESS', '0x9D061b24Fe052E5d0b61773d092faCDfe43C3AfF'),
    bondingCurve: resolveAddr('VITE_ARC_TESTNET_BONDING_CURVE_ADDRESS', 'VITE_BONDING_CURVE_ADDRESS', '0xA85937c095f72D41D0D06BFc4838373Ec5745bEa'),
    dexLister: resolveAddr('VITE_ARC_TESTNET_DEX_LISTER_ADDRESS', 'VITE_DEX_LISTER_ADDRESS', '0xc8460Ac88FB611F446F0508262cCa2599c1Ad06e'),
    longPool: resolveAddr('VITE_ARC_TESTNET_LONG_POOL_ADDRESS', 'VITE_LONG_POOL_ADDRESS', '0xAfc0878194C8EA4E2df92447927336781567993a'),
    shortPool: resolveAddr('VITE_ARC_TESTNET_SHORT_POOL_ADDRESS', 'VITE_SHORT_POOL_ADDRESS', '0xC96a7D56e68870b1AABdfc7fdb547957260ffdA8'),
    buyAndBurn: resolveAddr('VITE_ARC_TESTNET_BUY_AND_BURN_ADDRESS', 'VITE_BUY_AND_BURN_ADDRESS', '0xAa047fACbe037eCE67734592760dC5151Ff9f855'),
    priceOracle: resolveAddr('VITE_ARC_TESTNET_PRICE_ORACLE_ADDRESS', 'VITE_PRICE_ORACLE_ADDRESS', '0xb21CdE11364D184D0aA2069e77e6e7e24ddee3e7'),
    feeDistributor: resolveAddr('VITE_ARC_TESTNET_FEE_DISTRIBUTOR_ADDRESS', 'VITE_FEE_DISTRIBUTOR_ADDRESS', '0x8a0E84b09B4970b2Bf0DCbf22D94708cD12CD0a2'),
    creatorRewardManager: resolveAddr('VITE_ARC_TESTNET_CREATOR_REWARD_MANAGER_ADDRESS', 'VITE_CREATOR_REWARD_MANAGER_ADDRESS', '0x52d62703C18Eaa55ef70818B7f82D258E62BeDAA'),
    factory: resolveAddr('VITE_ARC_TESTNET_FACTORY_ADDRESS', 'VITE_FACTORY_ADDRESS', '0x9a5f05972b26b7afBa6F2911b1D38Fe8B6808a9C'),
    simpleFactory: resolveAddr('VITE_ARC_TESTNET_SIMPLE_FACTORY_ADDRESS', 'VITE_SIMPLE_FACTORY_ADDRESS', '0xeBC53271bfC2454ac7C7B1AAc703c42db720A741'),
    simpleRouter: resolveAddr('VITE_ARC_TESTNET_SIMPLE_ROUTER_ADDRESS', 'VITE_SIMPLE_ROUTER_ADDRESS', '0xCC72b3dA44bA00cf327CCf1C846dAa60AA53B311'),
  },
}
