...
export const CONTRACT_ADDRESSES: Record<number, ContractAddresses> = {
  ...
  [ARC_TESTNET]: {
    launchDAO: resolveAddr('VITE_ARC_TESTNET_LAUNCH_DAO_ADDRESS', 'VITE_LAUNCH_DAO_ADDRESS', '0x56504Ca95cE09c0c92AA11CBe8F07Bd5E57076ED'),
    bondingCurve: resolveAddr('VITE_ARC_TESTNET_BONDING_CURVE_ADDRESS', 'VITE_BONDING_CURVE_ADDRESS', '0x084467426aB415A3afCc46552dad342b8cDfE896'),
    longPool: resolveAddr('VITE_ARC_TESTNET_LONG_POOL_ADDRESS', 'VITE_LONG_POOL_ADDRESS', '0x3bEB222cAA12456E4EfB43aF2ba131866Ed04E79'),
    shortPool: resolveAddr('VITE_ARC_TESTNET_SHORT_POOL_ADDRESS', 'VITE_SHORT_POOL_ADDRESS', '0x9D68c46dC40c77Fdf1B3CEC0B9772f833f3ee4Fb'),
    buyAndBurn: resolveAddr('VITE_ARC_TESTNET_BUY_AND_BURN_ADDRESS', 'VITE_BUY_AND_BURN_ADDRESS', '0xec43cb625e7A7DAA2aa4572cCaad7Dd1583D68FA'),
    priceOracle: resolveAddr('VITE_ARC_TESTNET_PRICE_ORACLE_ADDRESS', 'VITE_PRICE_ORACLE_ADDRESS', '0x4ae1cd96e7438F0Fd686a4308CC1f4dB26598918'),
    feeDistributor: resolveAddr('VITE_ARC_TESTNET_FEE_DISTRIBUTOR_ADDRESS', 'VITE_FEE_DISTRIBUTOR_ADDRESS', '0x201f3C094193b71b480b3c11AD9bAfa37A97433e'),
    creatorRewardManager: resolveAddr('VITE_ARC_TESTNET_CREATOR_REWARD_MANAGER_ADDRESS', 'VITE_CREATOR_REWARD_MANAGER_ADDRESS', '0x0E7863FfA20A8e6B8E469f6141C5513043bc8ea8'),
    factory: resolveAddr('VITE_ARC_TESTNET_FACTORY_ADDRESS', 'VITE_FACTORY_ADDRESS', '0xa08f6E66C71ed1552a5aA2666d6359F840C7AE86'),
  },
}
