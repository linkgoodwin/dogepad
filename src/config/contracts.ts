...
export const CONTRACT_ADDRESSES: Record<number, ContractAddresses> = {
  ...
  [ARC_TESTNET]: {
    launchDAO: resolveAddr('VITE_ARC_TESTNET_LAUNCH_DAO_ADDRESS', 'VITE_LAUNCH_DAO_ADDRESS', '0x064Dd5E5B8fA38DB37608A2C92054b584FFa5c28'),
    bondingCurve: resolveAddr('VITE_ARC_TESTNET_BONDING_CURVE_ADDRESS', 'VITE_BONDING_CURVE_ADDRESS', '0x890598e28C2Ff78642f8bfAfc18efE8AB83D2597'),
